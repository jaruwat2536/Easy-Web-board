	...
	<body>
		...
		<div class="col-md-10" >
			<div class="panel panel-primary" >
				<div class="panel-heading" ><? echo mysql_result($qry,0,"title"); ?></div>
				<div class="panel-body"><div class="col-md-10" ><? echo mysql_result($qry,0,"p_body"); ?></div></div>
				<?if(mysql_result($qry,0,"email")==$email){?>
				<li class="active"><a href="edit_post.php?id=<? echo $p_id; ?>"><span class="glyphicon glyphicon"></span> Edit Post</a></li>
				<?}?>
		    </div>
		    ...
		    <div style="width:100%" >
				...
				<?	
					$qry_ment=mysql_query("select * from comment where p_id ='".$p_id."'");
					while($objResult = mysql_fetch_array($qry_ment)){
				?>
				<div class="well well-lg"><? echo $objResult["c_body"]; ?></div>
					<?}?>
				</div>
			</div>
		</div>
        ...
        <div class="col-md-5">
	        <div class="panel panel-info">
			  ...
			  <form name="form" method="POST" action="add_comment.php?id=<? echo $p_id; ?>">
